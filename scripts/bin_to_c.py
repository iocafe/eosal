...
def start_c_files():
    ...
    cfile.write('/* This file is generated by bin_to_c.py script, do not modify. */\n')
    hfile.write('/* This file is generated by bin_to_c.py script, do not modify. */\n')
...
def process_source_file(path, variablename):
    ...
    with open(path, mode='rb') as file: # b is important -> binary
        ...
        cfile.write('OS_PROGMEM os_uchar ' + variablename + '[' + str(l) + '] = {\n')
        hfile.write('extern OS_PROGMEM_H os_uchar ' + variablename + '[' + str(l) + '];\n')
