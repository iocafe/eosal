/**
  ...
  @file    utf16/common/osal_str_utf16_to_utf8_malloc.c
...
****************************************************************************************************
  ...
  @anchor osal_str_utf16_to_utf8_malloc

  The osal_str_utf16_to_utf8_malloc() converts an UTF16 encoded string to UTF8 encoded string.
  ...
  str = osal_str_utf16_to_utf8_malloc(utf16_str, &sz);
  os_free(str, sz);
  \endverbatim
    ...
    os_memsz *sz_ptr)
{
     ...
     */
    sz = osal_str_utf16_to_utf8(OS_NULL, 0, str16);
     ...
     */
    osal_str_utf16_to_utf8(buf8, sz, str16);
