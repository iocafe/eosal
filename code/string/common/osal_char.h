...
****************************************************************************************************
  ...
  Macros osal_char_isalpha(), osal_char_islower() and osal_char_isupper() work only with
  English alphabet.
...
/** The osal_char_isalpha() macro checks if c is an alphabetic character. The macro returns a
    non-zero value if c is within the ranges A - Z or a - z.
 */
#define osal_char_isalpha(c) (os_boolean)(((c) >= 'A' && (c) <= 'Z') || ((c) >= 'a' && (c) <= 'z'))
