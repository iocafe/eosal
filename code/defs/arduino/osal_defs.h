...
#define OSAL_ARDUINO_ETHERNET_WIZ (OSAL_ARDUINO_ETHERNET_BIT + 1)
#define OSAL_ARDUINO_ETHERNET_LWIP (OSAL_ARDUINO_ETHERNET_BIT + 2)
#define OSAL_ARDUINO_WIFI (OSAL_ARDUINO_WIFI_BIT + 0)
#define OSAL_ARDUINO_WIFI_ESP32 (OSAL_ARDUINO_WIFI_BIT + 1)
#define OSAL_LWIP_SOCKET_API (OSAL_LWIP_SOCKET_API_BIT + 0)
#define OSAL_LWIP_SOCKET_API_ARDUINO_WIFI (OSAL_LWIP_SOCKET_API_BIT + 1)
