...
#define OSAL_LWIP_NETCONN_API 3
#define OSAL_LWIP_RAW_API 4
#define OSAL_ARDUINO_ETHERNET_API 5
#define OSAL_ARDUINO_WIFI_API 6
#define OSAL_SAM_WIFI_API 7
#define OSAL_WIZ_API 10
#define OSAL_LWIP_SOCKET_API 32
...
#define OSAL_ARDUINO_ETHERNET_INIT (3 << 8)
#define OSAL_ARDUINO_WIFI_INIT (4 << 8)
...
#define OSAL_ARDUINO_ETHERNET_WIZ (OSAL_ARDUINO_ETHERNET_API + OSAL_ARDUINO_ETHERNET_INIT + OSAL_WIZ_API)
#define OSAL_ARDUINO_ETHERNET_LWIP (OSAL_ARDUINO_ETHERNET_API + OSAL_ARDUINO_ETHERNET_INIT)
#define OSAL_ARDUINO_WIFI (OSAL_ARDUINO_WIFI_API + OSAL_ARDUINO_WIFI_INIT)
#define OSAL_ARDUINO_WIFI_ESP32 (OSAL_ARDUINO_WIFI_API + OSAL_ARDUINO_WIFI_INIT)

#define OSAL_LWIP_SOCKET_API (OSAL_LWIP_SOCKET_API + 0)
#define OSAL_LWIP_SOCKET_API_ARDUINO_WIFI (OSAL_LWIP_SOCKET_API + OSAL_ARDUINO_WIFI_INIT)
#define OSAL_LWIP_NETCONN_API (OSAL_LWIP_NETCONN_API + 0)
#define OSAL_LWIP_NETCONN_API_ARDUINO_WIFI (OSAL_LWIP_NETCONN_API + OSAL_ARDUINO_WIFI_INIT)
#define OSAL_LWIP_RAW_API (OSAL_LWIP_RAW_API + 0)
#define OSAL_LWIP_RAW_API_ARDUINO_WIFI (OSAL_LWIP_RAW_API + OSAL_ARDUINO_WIFI_INIT)
