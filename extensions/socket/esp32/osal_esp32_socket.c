/**
  ...
  @file    socket/esp32/osal_esp32_socket.c
  @brief   OSAL stream API implementation for ESP32 sockets.
...
//            (a->ifa_flags & IFF_MULTICAST) &&   COMMENTED SINCE IFF_MULTICAST IS NOT DEFINED, NEED TO IMPLEMENT FOR ESP32
            (a->ifa_flags & IFF_UP) &&
