...
typedef enum osalStaticJsonDictionary
{
    ...
    OSAL_JSON_DICT_PINS = 27,
    OSAL_JSON_DICT_INPUTS = 28,
    OSAL_JSON_DICT_OUTPUTS = 29,
    OSAL_JSON_DICT_CONTROLS = 30,
    OSAL_JSON_DICT_FREQUENCY = 31,
    OSAL_JSON_DICT_RESOLUTION = 32,

    OSAL_JSON_DICT_DEVICE_NAME = 33,
