...
typedef enum
{
    ...
    OS_PBNR_ROOT_KEY = 7,
    OS_PBNR_ROOT_CERT = 8,
    OS_PBNR_CLIENT_CERT_CHAIN = 9,
    OS_PBNR_PUBLISH_CERT_CHAIN = 10,
    OS_PBNR_NODE_CONF = 11,
    OS_PBNR_AUTONR_DATA = 12,
    OS_PBNR_SYS_RESERVED_A = 13,
    OS_PBNR_CUST_A = 14,
    OS_PBNR_CUST_B = 15,
    OS_PBNR_CUST_C = 16,
    OS_PBNR_CUST_D = 17,
...
#define OSAL_PERSISTENT_AT_ONCE 4
#define OSAL_PERSISTENT_WRITE_AT_ONCE (OSAL_PERSISTENT_WRITE | OSAL_PERSISTENT_AT_ONCE)
#define OSAL_PERSISTENT_SECRET 16
#define OSAL_PERSISTENT_DELETE_ALL 32
