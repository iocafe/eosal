/**
  ...
  @file    secret/common/osal_secret.h
  ...
  can be "public" and accessible to anyone, at least in encrypted form.
  ...
  - Secret can be accessed by secure communication process only, it is not given out.
...
/* Convert binary data to secret string
 */
...
/* Create random secret and password into osal_global structure.
 */
void osal_make_random_secret(void);

/* Initialize secret and password (if not initialized already)
 */
