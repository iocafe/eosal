...
****************************************************************************************************
  ...
  The ioc_save_secret function writes 256 bit (32 bytes) secret to persistent block OS_PBNR_SECRET.

  @param   delete_secret OS_TRUE to write a secret with empty content.
  @return  If successful, the function return OSAL_SUCCESS. Other values indicate an error.
