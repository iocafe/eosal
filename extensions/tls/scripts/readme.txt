...
gedit create_root_CA_certificate.py

4. Create the CA certificate
python3 create_root_CA_certificate.py
...
3. Modify file "create_certificate_request.py" to have your information
gedit create_certificate_request.py

4. Create the certificate request
python3 create_certificate_request.py
...
3. Modify file "create_server_certificate.py" to have the right information (if needed)
gedit create_server_certificate.py

4. Create the server certificate
python3 create_server_certificate.py
...
cd /coderoot/eosal/extensions/tls/scripts
python3 create_client_certificate_chain.py
